...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.pill = await MockBEP20.deployed();
        ...
        await this.pill.transfer(bob, '2000', { from: minter });
        await this.pill.transfer(alice, '2000', { from: minter });
        await this.pill.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.pill.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.pill.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.pill.balanceOf(this.lotteryProxyAddress)).toString(), '418');
