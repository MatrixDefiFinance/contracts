...
// File: @matrixpilldefi/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/MatrixDefiProfile.sol

pragma solidity ^0.6.0;

/** @title MatrixDefiProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract MatrixDefiProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public pillToken;
    ...
    uint256 public numberPillToReactivate;
    uint256 public numberPillToRegister;
    uint256 public numberPillToUpdate;
    ...
    constructor(
        IBEP20 _pillToken,
        uint256 _numberPillToReactivate,
        uint256 _numberPillToRegister,
        uint256 _numberPillToUpdate
    ) public {
        pillToken = _pillToken;
        numberPillToReactivate = _numberPillToReactivate;
        numberPillToRegister = _numberPillToRegister;
        numberPillToUpdate = _numberPillToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends PILL to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer PILL tokens to this contract
        pillToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberPillToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer PILL token to this address
        pillToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberPillToUpdate
    ...
    /**
     * @dev Claim PILL to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        pillToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of PILL to register
     * Callable only by owner admins.
     */
    function updateNumberPill(
        uint256 newNumberPillToReactivate,
        uint256 _newNumberPillToRegister,
        uint256 _newNumberPillToUpdate
    ) external onlyOwner {
        numberPillToReactivate = newNumberPillToReactivate;
        numberPillToRegister = _newNumberPillToRegister;
        numberPillToUpdate = _newNumberPillToUpdate;
    }
